...
namespace ResumeExport.Models
{
    ...
    public class Resume
    {
        ...
        public Resume()
        {
            ...
            Description2 = "<img src=\"https://s.yimg.com/bt/api/res/1.2/zPQUUimgO8yTF6Fk9ByVPw--/YXBwaWQ9eW5ld3NfbGVnbztjaD00OTk7Y3I9MTtjdz03NDc7ZHg9MDtkeT0wO2ZpPXVsY3JvcDtoPTEyNztxPTc1O3c9MTkw/http://media.zenfs.com/zh-Hant-TW/homerun/nownews.com/514d816da52298329f328923c28cd7a0\" />";

            List<History> history = new List<History>
            {
                new History { CompanyName = "采威教育E化", JobTitle = "工讀生", StartDT = Convert.ToDateTime("2014/7/1"), EndDT = Convert.ToDateTime("2014/8/31") },
                new History { CompanyName = "采威教育E化", JobTitle = "一級工程師", StartDT = Convert.ToDateTime("2015/1/1"), EndDT = Convert.ToDateTime("2016/12/31") },
                new History { CompanyName = "采威教育E化", JobTitle = "二級工程師", StartDT = Convert.ToDateTime("2017/1/1") }
            };
            JobHistory = history;
        }
    }
