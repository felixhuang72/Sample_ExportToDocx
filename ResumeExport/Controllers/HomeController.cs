...
namespace ResumeExport.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            byte[] objFile = new FileService().ExportResumeByHtml();
        ...
        {
            byte[] objFile = new FileService().ExportResumeByDocx();
    ...
    public class FileService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public byte[] ExportResumeByHtml()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public byte[] ExportResumeByDocx()
        {
            MemoryStream ms = new MemoryStream();
            Spire.Doc.Document document = new Spire.Doc.Document();
